...
Source Database       : basecloud

Target Server Type    : MYSQL
Target Server Version : 50728
File Encoding         : 65001

Date: 2020-07-23 10:31:43
*/
...
-- ----------------------------
INSERT INTO `mem_login` VALUES ('1', '454332dffdfaad65543443', 'admin', '$2a$10$7jUnHQnnnmA94L5KxJNbzOYhBuu6yirfb0wcFu38ldD6HaCJYPzIu', '8', null, null, '1', null, null, null, null);
...
CREATE TABLE `sys_role` (
  ...
  `ds_type` char(1) NOT NULL DEFAULT '1' COMMENT '数据权限类型（1：全部数据权限 2：自定数据权限 3：本部门数据权限 4：本部门及以下数据权限）',
  `ds_scope` varchar(255) DEFAULT NULL COMMENT '数据范围',
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', '管理员', 'admin', '1', '2', '1', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '管理员');
INSERT INTO `sys_role` VALUES ('2', '普通角色', 'common', '2', '2', '2', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '普通角色');
