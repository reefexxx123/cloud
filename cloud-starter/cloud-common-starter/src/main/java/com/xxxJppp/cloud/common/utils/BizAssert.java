...
public class BizAssert {
    ...
    public static void fail(ResultEnum exceptionCode) {
        if (exceptionCode != null) {
            throw new BusinessException(exceptionCode.getMessage(), exceptionCode.getCode());
        }
        fail(ResultEnum.ERROR.getCode(), "参数验证异常");
    }
    ...
    public static void fail(String message) {
        ...
        fail(ResultEnum.ERROR.getCode(), message);
    }
     ...
     * @
     */
    public static void isTrue(boolean condition, ResultEnum exceptionCode) {
        if (!condition) {
            fail(exceptionCode);
        }
    }
     ...
     * @
     */
    public static void isFalse(boolean condition, ResultEnum exceptionCode) {
        if (condition) {
            fail(exceptionCode);
        }
    }
     ...
     * @
     */
    public static void notNull(Object object, ResultEnum exceptionCode) {
        if (object == null) {
            fail(exceptionCode);
        }
    }
     ...
     * @
     */
    public static void isNull(Object object, ResultEnum exceptionCode) {
        if (object != null) {
            fail(exceptionCode);
        }
    }
     ...
     * @
     */
    public static void notEmpty(Collection<?> collection, ResultEnum exceptionCode) {
        if (collection == null || collection.isEmpty()) {
            fail(exceptionCode);
        }
    }

    public static <T> void notEmpty(T[] array, ResultEnum exceptionCode) {
     ...
     * @
     */
    public static void notEmpty(String value, ResultEnum exceptionCode) {
     ...
     * @
     */
    public static void notEquals(Object unexpected, Object actual, ResultEnum exceptionCode) {
     ...
     * @
     */
    public static void equals(String expected, String actual, ResultEnum exceptionCode) {
