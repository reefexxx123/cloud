...
import com.xxxJppp.cloud.auth.exception.UnauthorizedException;
...
/**
 * 重写RemoteTokenServices 解决判断active类型bug，返回类型错误bug
 *
 * @author xxxJppp
 * @version 1.0
 * @date 2020/7/6
 */
public class BaseRemoteTokenServices implements ResourceServerTokenServices {
    ...
    public BaseRemoteTokenServices() {
    ...
    public OAuth2Authentication loadAuthentication(String accessToken) throws AuthenticationException, InvalidTokenException {
        ...
        //返回application/json格式，否则返回application/xml格式，会出现类型转换错误
        ...
        } else if (!Boolean.TRUE.equals(Boolean.parseBoolean(map.get("active").toString()))) {
